...
dtcm.save('/home/kl/Documents/Expedia-Hotel-Prediction-Workflow/data/dtcm_model')

# Load Pre-Trained Logistic Regression Model
dtcModel = DecisionTreeClassificationModel.load("/home/kl/Documents/Expedia-Hotel-Prediction-Workflow/data/dtcm_model")
...
# Save trained Logistic Regression Model to s3 Bucket
rfm.save('/home/kl/Documents/Expedia-Hotel-Prediction-Workflow/data/rfm_model')

# Load Pre-Trained Logistic Regression Model
rfModel = RandomForestClassificationModel.load("/home/kl/Documents/Expedia-Hotel-Prediction-Workflow/data/rfm_model")
...
lrm.save('/home/kl/Documents/Expedia-Hotel-Prediction-Workflow/data/lrm_model')

lrModel = LogisticRegressionModel.load("/home/kl/Documents/Expedia-Hotel-Prediction-Workflow/data/lrm_model")
...
pd_df4 = pd_df4.rename('ensemblePredictions')

# Convert the Pandas Series to a Pandas DataFrame
pd_df4 = pd_df4.to_frame()

# Convert the Pandas DataFrame to a Spark DataFrame to export as Parquet
sdf = sqlContext.createDataFrame(pd_df4)

# Write the final predictions of the ensemble model to an s3 bucket in parquet format
sdf.write.parquet("/home/kl/Documents/Expedia-Hotel-Prediction-Workflow/data/finalPredictions.parquet")

toc = time.perf_counter()

print("Total Time On Standalone Machine:", round(toc-tic, 3), "seconds")
